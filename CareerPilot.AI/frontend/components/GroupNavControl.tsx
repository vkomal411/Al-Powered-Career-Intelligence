...
export const RESUME_TOOLS_NAV: NavItem[] = [
  ...
  { id: "cover-letter-generator", label: "Cover Letter Generator", route: "/resume-tools/cover-letter-generator" },
  { id: "resume-builder", label: "Resume Builder", route: "/resume-tools/resume-builder" },
];

export const CAREER_SUGGESTION_ROUTE = "/career-tools/career-suggestion";

export const CAREER_TOOLS_NAV: NavItem[] = [
  { id: "career-suggestion", label: "Career Suggestion", route: "/career-tools/career-suggestion" },
